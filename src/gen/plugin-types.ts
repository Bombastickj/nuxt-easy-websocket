...
*/
import type { EasyWSClientState, EasyWSRawPayload } from '${typeImportPath}';
import type { EasyWSExternalRoutes, EasyWSClientArguments, EasyWSExternalArguments, EasyWSServerRoutes } from '#nuxt-easy-websocket/routes';

type NuxtEasyWebSocketPlugin = {
  send: <T extends keyof EasyWSServerRoutes>(...args: EasyWSClientArguments<T>) => Promise<void>
  sendRaw: (data: EasyWSRawPayload) => Promise<void>
